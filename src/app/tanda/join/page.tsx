      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900">
        ...
        <div className="max-w-6xl mx-auto space-y-4 sm:space-y-6">
          <div className="text-center">
            <h1 className="text-2xl sm:text-3xl font-bold text-gradient mb-3 sm:mb-4">Explorar Tandas</h1>
            <p className="text-sm sm:text-base text-muted-foreground">Cargando tandas disponibles...</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[1, 2, 3, 4, 5, 6].map(i => (
              <div key={i} className="h-48 sm:h-64 bg-muted/20 rounded-lg animate-pulse" />
            ))}
          </div>
        </div>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900">
      ...
      <div className="max-w-6xl mx-auto space-y-4 sm:space-y-6">
        ...
        <div className="text-center space-y-3 sm:space-y-4">
          <h1 className="text-2xl sm:text-3xl font-bold text-gradient">Explorar Tandas</h1>
        ...
        {filteredTandas.length === 0 ? (
          <GlassCard className="p-8 sm:p-12 text-center">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2">No hay tandas disponibles</h3>
              ...
              >
                <GlassCard className="p-4 sm:p-6 h-full flex flex-col">
                  <div className="flex-1 space-y-3 sm:space-y-4">
                    <div>
                      <h3 className="font-semibold text-base sm:text-lg mb-1">{tanda.name}</h3>
        ...
        <GlassCard className="p-4 sm:p-6 bg-gradient-to-r from-blue-500/10 to-indigo-500/10">
          <div className="flex gap-3 sm:gap-4">
            ...
            <div className="space-y-2">
              <h3 className="font-semibold text-sm sm:text-base">¿Cómo funcionan las tandas?</h3>
